#!/bin/bash
#SBATCH --job-name=lenia_jepa_v2
#SBATCH --output=logs_lenia_jepa_v2_%j.out
#SBATCH --error=logs_lenia_jepa_v2_%j.err
...
RESULTS_DIR="$HOME/lenia-results/jepa_v2_$SLURM_JOB_ID"
...
echo "=== STEP 5: Start JEPA-CNN training ==="
