#!/bin/bash
#SBATCH --job-name=lenia_vit_v2
#SBATCH --output=logs_lenia_vit_v2_%j.out
#SBATCH --error=logs_lenia_vit_v2_%j.err
...
RESULTS_DIR="$HOME/lenia-results/vit_v2_$SLURM_JOB_ID"
...
echo "=== STEP 5: Start Pixel-ViT training ==="
export WANDB_MODE=offline
mkdir -p "$WORK_DIR/experiments"

$PYTHON scripts/train_single.py --setup pixel --config config_cluster_vit_v2.yaml
EXIT_CODE=$?
