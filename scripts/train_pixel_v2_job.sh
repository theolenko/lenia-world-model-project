#!/bin/bash
#SBATCH --job-name=lenia_pixel_v2
#SBATCH --output=logs_lenia_pixel_v2_%j.out
#SBATCH --error=logs_lenia_pixel_v2_%j.err
...
RESULTS_DIR="$HOME/lenia-results/pixel_v2_$SLURM_JOB_ID"
...
echo "=== STEP 5: Start Pixel-CNN training ==="
