#!/bin/bash
#SBATCH --job-name=lenia_decoder_v2
#SBATCH --output=logs_lenia_decoder_v2_%j.out
#SBATCH --error=logs_lenia_decoder_v2_%j.err
...
RESULTS_DIR="$HOME/lenia-results/decoder_v2_$SLURM_JOB_ID"
PYTHON="$HOME/.conda/envs/lenia-wm/bin/python"

# Path to the best JEPA checkpoint on the persistent home directory
JEPA_CKPT="$HOME/lenia-results/jepa_v2_22782975/experiments/jepa_20260622_224445/checkpoint_best.pt"
